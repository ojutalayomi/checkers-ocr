...
pyinstaller --onefile --name="DeliveryNoteScanner" --hidden-import="Cocoa" --hidden-import="Vision" --hidden-import="Foundation" app.py
...
```bash
pip install pyinstaller
pyinstaller --onefile --name="DeliveryNoteScanner" --hidden-import="winrt.windows.media.ocr" --hidden-import="winrt.windows.graphics.imaging" --hidden-import="winrt.windows.storage.streams" app.py
